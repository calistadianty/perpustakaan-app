...
@section('page-title', 'Daftar Pembaca')
...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-gray-500">Akun pembaca yang terdaftar melalui registrasi</p>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-right">
                            <form action="{{ route('admin.pembaca.destroy', $user) }}" method="POST" 
