...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 grid md:grid-cols-3 gap-4">
            ...
            <div class="border border-gray-200 rounded-xl p-5 flex flex-col gap-3">
                ...
                <a href="{{ route('admin.laporan.buku-populer') }}"
            ...
            <div class="border border-gray-200 rounded-xl p-5 flex flex-col gap-3">
                ...
                <a href="{{ route('admin.laporan.keterlambatan') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('admin.laporan.index') }}" method="GET" class="p-6">
    ...
    <!-- Preview Table (muncul setelah klik Generate) -->
    @if($filtered)
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('admin.laporan.peminjaman', request()->only(['dari', 'sampai', 'status'])) }}"
