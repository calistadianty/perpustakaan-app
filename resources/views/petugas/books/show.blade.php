...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="mb-2">
        <a href="{{ route('petugas.books.index') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 transition mb-4">
            ...
            <div class="md:col-span-2 p-8">
                ...
                <div class="pt-6 border-t border-gray-100 flex gap-3">
                    <a href="{{ route('petugas.books.edit', $book) }}" 
                       class="inline-block px-4 py-2 bg-orange-50 text-orange-600 hover:bg-orange-100 transition rounded-lg font-medium border border-orange-200">
        ...
        <div class="divide-y divide-gray-100">
            @forelse($book->reviews as $review)
                <div class="px-6 py-5 flex items-start gap-4">
                    ...
                    {{-- Delete --}}
                    <form action="{{ route('petugas.books.reviews.destroy', [$book->id, $review->id]) }}" method="POST" class="flex-shrink-0">
                        @csrf
                        @method('DELETE')
